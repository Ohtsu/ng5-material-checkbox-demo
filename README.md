...
# _ng5-material-checkbox-demo_ Angular5 initial project installed with libraries which are needed for Angular Material
...
```
   ...
   - Change into _ng5-material-checkbox-demo_ and run "npm install".
